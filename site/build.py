...
for app_id, app in apps.items():
    ...
    if candidates:
        ...
        download = f'<a class="button primary" href="{html.escape(asset["browser_download_url"], quote=True)}">Download for Mac <span aria-hidden="true">↓</span></a>'
        ...
        details = '<span class="release-note">Preparing the first notarized release.</span>'
