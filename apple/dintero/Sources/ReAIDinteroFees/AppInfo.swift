...
enum AppInfo {
    ...
    static let helpURL = URL(string: "https://docs.dintero.com/docs/checkout/checkout-client")!
    ...
    static let credentialHint = "Create an API client in Dintero Backoffice with read access to settlements. Paste its client ID and secret; no browser OAuth."
}
